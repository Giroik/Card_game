...
public class PlayingCard {
  ...
  static final int cardHeight = 150;
  static final int cardWidth = 130;

  private final String suit; // 'S'=spade, 'H'=heart, 'D'=diamonds, 'C'=clubs
  private final String face; // a number between 1 and A
   ...
   */
  public PlayingCard(String suit, String face, int intValue) {
    ...
    this.imgPath = "src/main/java/src/cards/" + face + suit + ".png";
    this.card=""+face+ suit;
  }
  ...
  /**
   * Returns the path to the image file of the card.
   * @return the path to the image file of the card
   */
 ...
 @Override
    public int hashCode() {
        return getSuit().hashCode() + getFace().hashCode();
    }
